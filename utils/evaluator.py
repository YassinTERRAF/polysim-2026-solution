...
class Evaluator:
    ...
    def accuracy_missing_face(self, dataset, head="fusion"):
        """
        Accuracy when face modality is missing.
        This simulates P4/P6 evaluation.
        """
        face, audio, labels = self._get_tensors(dataset)
        ...
        face_zero = torch.zeros_like(face)
